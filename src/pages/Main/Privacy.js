                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <p className="section__text">It is a long established fact that a reader will be distracted
                            ...
                            <p className="section__text">Many desktop publishing packages and <a href="#">web
                                page</a> editors now use Lorem Ipsum as their default model text, and a search for
                                ...
                                the like).</p>
                            <p className="section__text">All the Lorem Ipsum generators on the <b>Internet</b> tend to
                                    ...
                                    <li>
                                        ...
                                        <ol>
                                            <li>If you are going to use a passage of Lorem Ipsum:
                                                <ol>
                                                    <li>All the Lorem Ipsum generators on the Internet tend to repeat
                                                        predefined chunks as necessary, making this the first true
                                                        generator on the Internet.
                                                    </li>
                                                    <li>It uses a dictionary of over 200 Latin words, combined with a
                                        ...
                                        <ol>
                                            ...
                                            <li>All the Lorem Ipsum generators on the Internet tend to repeat predefined
                                                ...
                                                <ol>
                                                    ...
                                                    <li>Various versions have evolved over the years, sometimes by
                                                        accident, sometimes on purpose (injected humour and the like);
                                                    </li>
                                                    <li>Many desktop publishing packages and web page editors now use
