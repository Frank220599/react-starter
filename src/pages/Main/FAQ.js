                    ...
                    <div className="row">
                        <div className="col-12 col-md-6">
                            <div className="faq">
                                ...
                                <p className="faq__text">All the Lorem Ipsum generators on the Internet tend to repeat
                                    predefined chunks as necessary, making this the first true generator on the
                                    Internet.</p>
                                <p className="faq__text">Various versions have evolved over the years, sometimes by
                                    accident, sometimes on purpose (injected humour and the like).</p>
                            </div>

                            <div className="faq">
                                <h3 className="faq__title">Why isn't there a HD version of this video?</h3>
                                <p className="faq__text">Many desktop publishing packages and web page editors now use
                            ...
                            <div className="faq">
                                <h3 className="faq__title">Why is the Video stuttering, buffering or randomly
                                    stopping?</h3>
                                <p className="faq__text">There are many variations of passages of Lorem Ipsum available,
                            ...
                            <div className="faq">
                                ...
                                <p className="faq__text">If you are going to use a passage of Lorem Ipsum, you need to
                        ...
                        <div className="col-12 col-md-6">
                            <div className="faq">
                                ...
                                <p className="faq__text">The point of using Lorem Ipsum is that it has a more-or-less
                            ...
                            <div className="faq">
                                ...
                                <p className="faq__text">It uses a dictionary of over 200 Latin words, combined with a
                            ...
                            <div className="faq">
                                ...
                                <p className="faq__text">It was popularised in the 1960s with the release of Letraset
